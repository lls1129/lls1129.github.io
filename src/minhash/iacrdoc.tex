...
\subsection{Invocation and usage}
...
\subsection{Typesetting the Bibliography}
\label{sec:biblio}
...
\subsection{Package load order}\label{sec:loadorder}
...
\subsection{Some recommendations}\label{sec:options}
