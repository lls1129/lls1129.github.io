...
For any $A, I, n_B$ and $n_R = n_B - n_I$, we have
 ...
 \frac{n_I}{n_A} ~~.\]
\end{lemma}
The proof is found in Appendix~\ref{apx:proof:good_event}.
...
\end{lemma}
The proof is found in Appendix~\ref{apx:proof:good_hash}.
...
The proof is found in Appendix~\ref{apx:proof:pb-dp}.
