...
\paragraph{Additional assumptions about $\w_1$ and $\w_2$}. 
We assumed that $\w_1$ and $\w_2$ are normalized and correlated such
that $\ipw = \omega(\log n/n)$. In a similar vein, we assume that the
