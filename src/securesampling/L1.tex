...
\end{theorem} 
The proof is found in Appendix~\ref{apx:pfTheorem1}.
...
\end{theorem} 
The proof is found in Appendix~\ref{apx:pfTheorem2}.
...
exponential in the bit precision in Appendix~\ref{apx:otl1}.  

\paragraph{Securely realizing $\F_\bcoin$.} The secure construction for
$\F_\bcoin$ is straightforward and can be found in Appendix~\ref{apx:bcoin}. 
