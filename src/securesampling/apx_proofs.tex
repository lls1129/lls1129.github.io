\section{Proofs} \label{apx:proof}

\subsection{Proof of Theorem~\ref{th:l1}}\label{apx:pfTheorem1}
...
\subsection{Proof of Theorem~\ref{thm:os-fhe}}\label{apx:pfTheorem2}
...
\subsection{Proof of Theorem~\ref{th:l2}} \label{apx:pfTheorem3}
...
%
%\subsection{Proof of Theorem~\ref{th:l2}}
...
\subsection{Proof of Lemma~\ref{lem:close_dist_2}}\label{apx:pfLemma5}
...
\subsection{Proof of Lemma~\ref{lem:lp}}\label{apx:pfLemma6}
...
\subsection{Proof of Lemma~\ref{lem:simip}}\label{apx:pfLemma10}
